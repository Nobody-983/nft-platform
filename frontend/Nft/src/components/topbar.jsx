    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-[#08080f]/80 backdrop-blur-xl">
      <div className="flex h-20 items-center gap-4 px-5 lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <span className="hidden rounded-full border border-yellow-500/20 bg-yellow-500/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-yellow-400 sm:inline">
            Testnet
          </span>
